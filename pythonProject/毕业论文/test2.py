...
coe_start[0]=15;coe_start[1]=0.5;coe_start[2]=5           #初值
coe_int[0]=0.1;coe_int[1]=0.01;coe_int[2]=0.1         #间隔
...
with open('/home/dell/ZQ19/bysj/xbest2.txt','w') as outfile:
    np.savetxt(outfile,xbest)
with open('/home/dell/ZQ19/bysj/ysimulate2.txt','w') as outfile:
