...
ds=xr.open_dataset('D:/XC/wind-big-850.nc')
lat=ds.latitude
lon=ds.longitude
#筛选出1979.12--2019.12
...
cb = plt.colorbar(ax=ax, orientation="vertical", pad=0.06, aspect=16, shrink=0.8)
